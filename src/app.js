...
const UAParserModule = __importStar(require("ua-parser-js"));
...
app.get('/api/items', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const creds = config_1.CONFIG.dbPassword;
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        const items = yield (0, service_1.getItemsFromDatabase)(config_1.CONFIG.dbPassword);
        const sorted = yield (0, sortUtil_1.getSortedItemsNames)(items.map(i => i.name));
        console.log('Sorted item names 1:', sorted);
    });
}
main().catch(err => {
